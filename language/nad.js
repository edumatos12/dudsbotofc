...
exports.noregis = () => {
	return`*「🐊」SEM REGISTRO*\n*Para se registrar use ${prefix}daftar nome|idade* \n\n*exemplo ${prefix}daftar duds|18*`
}

exports.baned = () => {
	return`*Esse usuário foi banido de utilizar o menu e alguns comandos do bot-DUDS!*`
}

exports.premium = () => {
	return`*Somente usuários premium podem utilizar*`
}
...
exports.ownerb = () => {
	return`*Somente o dono do bot pode utilizar esses comandos.*`
}
...
exports.bug = () => {
	return`*O problema foi relatado ao DUDS🐊*`
}

exports.wrongf = () => {
	return`*Coloque o texto*\n\n*Exemplo: !efeitin2 Duds/Teste*`
}
